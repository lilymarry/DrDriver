...
@interface CancelTripViewController () <UITableViewDelegate,UITableViewDataSource,UITextViewDelegate>
...
@implementation CancelTripViewController
...
-(void)creatHttp
{
    [AFRequestManager postRequestWithUrl:DRIVER_CANCEL_ORDER_REASON params:@{@"driver_id":[[NSUserDefaults standardUserDefaults] objectForKey:@"userid"],@"token":[[NSUserDefaults standardUserDefaults] objectForKey:@"token"]} tost:NO special:0 success:^(id responseObject) {
...
-(void)submitButtonClicked
{
    ...
    [AFRequestManager postRequestWithUrl:DRIVER_CANCEL_ORDER params:@{@"driver_id":[[NSUserDefaults standardUserDefaults] objectForKey:@"userid"],@"order_id":_orderID,@"cancel_reason":season,@"token":[[NSUserDefaults standardUserDefaults] objectForKey:@"token"]} tost:YES special:0 success:^(id responseObject) {
        
        [CYTSI otherShowTostWithString:@"取消订单操作成功"];
        ...
        for (ViewController * vc in vcArray) {
            ...
            if ([vc isKindOfClass:[ViewController class]]) {
                ...
                [[NSNotificationCenter defaultCenter] postNotificationName:@"beginListen" object:self userInfo:nil];
