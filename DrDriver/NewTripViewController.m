...
@interface NewTripViewController ()<UIScrollViewDelegate>
@property (strong, nonatomic) UIScrollView *bgScrollView;
@property(nonatomic,strong)TripViewController *tripVC;
@property(nonatomic,strong)NewITTripViewController *scanTripVC;
...
- (void)createUI
{
    ...
    [self.tripBtn setTitle:@"普通订单" forState:(UIControlStateNormal)];
    ...
    [self.scanTripBtn setTitle:@"一口价订单" forState:(UIControlStateNormal)];
...
-(NewITTripViewController *)scanTripVC{
    if (!_scanTripVC){
        _scanTripVC = [[NewITTripViewController alloc] init];
    }
    return _scanTripVC;
}
