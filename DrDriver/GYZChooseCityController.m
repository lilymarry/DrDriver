...
-(void)viewDidLoad{
    ...
    [navBackButton addTarget:self action:@selector(cancelButtonDown:)forControlEvents:UIControlEventTouchUpInside];
...
//    self.searchBar.barStyle     = UIBarStyleDefault;
    ...
    [self.tableView setSectionIndexColor:[UIColor lightGrayColor]];
    ...
    [geocoder reverseGeocodeLocation:currentLocation completionHandler:^(NSArray *array, NSError *error)
     {
         if (array.count >0)
         {
             ...
             if (self.localCityData.count <= 0) {
                 ...
                 NSLog(@"city.cityName%@ city.shortName%@",city.cityName,city.shortName);
