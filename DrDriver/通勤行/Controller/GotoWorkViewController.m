...
@interface GotoWorkViewController ()<UITableViewDelegate, UITableViewDataSource, GoToWorkTableViewCellDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate, MAMapViewDelegate, AMapNaviDriveManagerDelegate, DriveNaviViewControllerDelegate, AMapLocationManagerDelegate, AMapNaviDriveDataRepresentable>
{
...
@implementation GotoWorkViewController
...
- (void)creatHttp
{
    ...
    [AFRequestManager postRequestWithUrl:DRIVER_WORKBUS_ROUTE_DETIAL params: @{ @"driver_id": [[NSUserDefaults standardUserDefaults] objectForKey:@"userid"], @"token": [[NSUserDefaults standardUserDefaults] objectForKey:@"token"], @"route_id": self.route_id } tost:YES special:0 success:^(id responseObject) {
        NSLog(@"DRIVER_WORKBUS_ROUTE_DETIAL --- %@", responseObject[@"data"]);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    GoToWorkTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"GoToWorkTableViewCell"];
    if (!cell) {
        cell = [[GoToWorkTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"GoToWorkTableViewCell"];
...
- (void)tableViewCell:(UITableViewCell *)tableViewCell clickStateButton:(SLStudent *)student {
    ...
    if ([student.order_state isEqualToString:@"3"]) {//乘客上车
...
- (void)tableViewCell:(UITableViewCell *)tableViewCell clickPhotoButton:(SLStudent*)student {
    self.order_id = student.order_id;
    [self tableViewCell:nil clickStateButton:student];
}
